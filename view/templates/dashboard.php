    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Accueil</h1>
            ...
            <img class="mb-4" src="https://avatars.githubusercontent.com/u/72943767?v=4" alt="" width="72" height="72" style="border-radius:50px;">
                <h1 class="display-5 fw-bold text-body-emphasis">Gestion de stages</h1>
