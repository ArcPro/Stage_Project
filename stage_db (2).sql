...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : jeu. 12 oct. 2023 à 11:17
...
CREATE TABLE IF NOT EXISTS `etudiant` (
  ...
  KEY `fk_etudiant_classe` (`Classe_Etudiant`)
...
(6, 'Arcc', 'Arc', 'Arc@f.r', '$2y$10$/MnkdkWRL5xmIGThIIDZSenT51F5gZ4zve5cCQU0URKN2cxQ5aTCS', 1);
...
CREATE TABLE IF NOT EXISTS `stage` (
  ...
  KEY `fk_stage_professeur` (`Professeur_ID`),
  KEY `fk_stage_etudiant` (`Etudiant_ID`),
  KEY `fk_stage_entreprise` (`Entreprise_ID`)
